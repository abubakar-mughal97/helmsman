...
The workspace contains three main packages located under the `src/` directory:
...
- **[helmsman_description](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_description)**: Defines the physical structure, collision boxes, inertia parameters, visual colors (charcoal body, orange bumpers, teal accents), and sensor configurations of the robot.
- **[helmsman_gazebo](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_gazebo)**: Connects the robot model to the Gazebo simulation environment using `ros_gz_sim` and `ros_gz_bridge`. It features a custom hold-to-drive keyboard teleoperation script.
- **[helmsman_navigation](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_navigation)**: Manages slam_toolbox and Nav2 localization stack mapping files.

---

## 🤖 Robot Specifications (Helmsman)

The robot configuration is detailed in [helmsman.urdf.xacro](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_description/urdf/helmsman.urdf.xacro). Here are the key specifications:
...
1. **[helmsman.gazebo.xacro](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_description/urdf/helmsman.gazebo.xacro)**:
...
2. **[bridge.yaml](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_gazebo/config/bridge.yaml)**: Defines mappings between ROS 2 topics and Gazebo Sim topics.
...
### 1. Build and Source
Execute these commands in the root of your workspace (`/home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws`):
...
```
*Launch components defined in [display.launch.py](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_description/launch/display.launch.py)*:
...
### 3. Launch Simulation in the Warehouse
...
#### Launch Configurations/Arguments in [sim.launch.py](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_gazebo/launch/sim.launch.py):
* `rviz` (default: `true`): Starts RViz loaded with robot links, lidar, and camera visualization.
* `teleop` (default: `true`): Starts the custom hold-to-drive pygame utility window.
...
* **Source implementation**: [keyboard_teleop.py](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_gazebo/scripts/keyboard_teleop.py).
...
```
*Uses parameters from [slam_async.yaml](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_navigation/config/slam_async.yaml).*
...
### 5. Run Localization (AMCL)
If you are navigating on a pre-generated map ([warehouse.yaml](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_navigation/maps/warehouse.yaml) and [warehouse.pgm](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_navigation/maps/warehouse.pgm)), launch the map server and Adaptive Monte Carlo Localization (AMCL):

```bash
ros2 launch helmsman_navigation localization.launch.py
```
*Launch configurations defined in [localization.launch.py](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_navigation/launch/localization.launch.py) use [amcl.yaml](file:///home/haris/SharedDrive/Harris/Desktop/ros2_workspaces/helmsman/ws/src/helmsman_navigation/config/amcl.yaml).*
...
graph TD
    ...
    odom -->|Gazebo diff_drive Plugin| base_footprint[base_footprint]
